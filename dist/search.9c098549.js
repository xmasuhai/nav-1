...
$(document).ready(function () {
  ...
  var searchResult = localStorage.getItem('searchResult') || 'null'; // console.log(searchResult);
  // 将读取的字符串 变为 对象

  var queryString = JSON.parse(searchResult);
  console.dir(queryString);
  var url = $.url();
  console.log(url); // var query = url.param("q");
  // console.log(query);
...
//# sourceMappingURL=search.9c098549.js.map